 ...
 * @author btanner
 */
public class RewardObservationActionTerminal {
    ...
    public RewardObservationActionTerminal() {
        r = 0;
        o = new Observation();
        a = new Action();
        terminal = 0;
    ...
    public RewardObservationActionTerminal(double reward, Observation observation, Action action, int terminal) {
     ...
     */
    public RewardObservationActionTerminal(double reward, Observation observation, Action action, boolean terminal) {
        this.r = reward;
        this.o = observation;
        this.a = action;
    ...
    public RewardObservationActionTerminal(RewardObservationActionTerminal src) {
        this.r = src.r;
    ...
    public RewardObservationActionTerminal duplicate() {
        return new RewardObservationActionTerminal(this);
    }
}
