 ...
 * @author btanner
 */
public class RewardObservationTerminal {

    public double r;
    public Observation o;
    public int terminal;

    public RewardObservationTerminal() {
        r        = 0;
        o        = new Observation();
        terminal = 0;
    }

    public RewardObservationTerminal(double reward, Observation observation, int terminal) {
     ...
     */
    public RewardObservationTerminal(double reward, Observation observation, boolean terminal) {
     ...
     * @param src
     */
    public RewardObservationTerminal(RewardObservationTerminal src) {
    ...
    public RewardObservationTerminal duplicate() {
        return new RewardObservationTerminal(this);
    }
}
