 ...
 *  $HeadURL: http://rl-glue-ext.googlecode.com/svn/trunk/projects/codecs/Java/src/org/rlcommunity/rlglue/codec/types/Action.java $
 *
 */
...
public class Action extends RLAbstractType {
    ...
    public Action(RLAbstractType src) {
        super(src);
    }
