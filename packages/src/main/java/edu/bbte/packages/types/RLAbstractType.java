...
public class RLAbstractType implements Comparable {
     ...
     */
    public RLAbstractType(int numInts, int numDoubles, int numChars) {
     ...
     * @param src
     */
    public RLAbstractType(RLAbstractType src) {
     ...
     * @param dest
     */
    public static void RLStructCopy(RLAbstractType src, RLAbstractType dest) {
    ...
    public String toString() {
    	...
    	if (intArray != null) {
    		b.append(intArray.length).append(";");
    		for (int i : intArray) {
    			b.append(i).append(":");
    		}
    		b.append("\n");
    	...
    	if (doubleArray != null) {
    		b.append(doubleArray.length).append(";");
    	...
    	if (charArray != null) {
    		b.append(charArray.length).append(";");
    ...
    public int compareTo(Object cObject) {
        ...
        RLAbstractType compareO = (RLAbstractType) cObject;
