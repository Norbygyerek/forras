...
*  $HeadURL: http://rl-glue-ext.googlecode.com/svn/trunk/projects/codecs/Java/src/org/rlcommunity/rlglue/codec/taskspec/TaskSpecObject.java $
* 
*/
import java.util.StringTokenizer;
/**
 * @author mradkie
 * @deprecated As of TaskSpec v3, now use {@link edu.bbte.packages.taskSpec.rlcommunity.rlglue.codec.taskspec.TaskSpec}
 */
