...
public class ParameterHolder {
	...
	private static final Logger logger = LoggerFactory.getLogger (ParameterHolder.class);
    ...
    public static void main(String[] args) {
        ...
        if (parameterString.equals(cppString)) {
           logger.info("The strings are the same");
        }
    ...
    public ParameterHolder(final String theString) {
        ...
        //Alias time
        int numAliases = Integer.parseInt(iss.nextToken());
    ...
    public void setAlias(String thisAlias, String thisTarget) {
        if (thisAlias.contains(":") || thisAlias.contains("_")) {
        	logger.error("The name or alias of a parameter cannot contain a space or : or _");
            Thread.dumpStack();
            System.exit(1);
        }

        if (allParams.get(thisTarget) == null) {
        	logger.error("Careful, you are setting an alias of: " + thisAlias + " to original: " + thisTarget + " but the original isn't in the parameter set!");
            Thread.dumpStack();
            System.exit(1);
        }
    ...
    public void addStringParam(String thisParamName, String thisParamValue) {
        if (thisParamName.contains(":") || thisParamName.contains("_")) {
        	logger.error("The ParameterName " + thisParamName + " with Parameter Value " + thisParamValue + " cannot contain a : or _");
            Thread.dumpStack();
            System.exit(1);
        }
    ...
    public void addStringParam(String thisParamName) {
        if (thisParamName.contains(":") || thisParamName.contains("_")) {
        	logger.error("The ParameterName " + thisParamName + " cannot contain a : or _");
            Thread.dumpStack();
            System.exit(1);
        }
    ...
    public void setStringParam(String thisParamAlias, String thisParamValue) {
        ...
        if (!allParams.containsKey(name)) {
        	logger.error("Careful, you are setting the value of parameter: " + name + " but the parameter hasn't been added...");
        }
    ...
    public void setDoubleParam(String thisParamAlias, Double thisParamValue) {
        if (thisParamAlias.contains(":") || thisParamAlias.contains("_")) {
        	logger.error("The ParameterAlias " + thisParamAlias + " cannot contain a : or _");
            Thread.dumpStack();
            System.exit(1);
        }
        String name = getAlias(thisParamAlias);
    ...
    private String getAlias(String thisParamAlias) {
        ...
        if (!aliases.containsKey(thisParamAlias)) {
        	logger.error("You wanted to look up original for alias: " + thisParamAlias + ", but that alias hasn't been set");
            Thread.dumpStack();
            System.exit(-1);
        }
    ...
    private String getStringParamEncoded(String theAlias) {
        ...
        if (!allParams.containsKey(name)) {
        	logger.error("Careful, you are getting the value of parameter: " + name + " but the parameter hasn't been added...");
            System.exit(1);
        }
        if (!stringParams.containsKey(name)) {
        	logger.error("Careful, you are getting the value of parameter: " + name + " but the parameter isn't a String parameter...");
            System.exit(1);
        }
    ...
    public double getDoubleParam(String theAlias) {
        ...
        if (!doubleParams.containsKey(name)) {
        	logger.error("Careful, you are getting the value of parameter: " + name + " but the parameter isn't a double parameter...");
            System.exit(1);
        }
    ...
    public boolean getBooleanParam(String theAlias) {
        ...
        if (!boolParams.containsKey(name)) {
        	logger.error("Careful, you are getting the value of parameter: " + name + " but the parameter isn't a bool parameter...");
            System.exit(1);
        }
    ...
    public int getIntegerParam(String theAlias) {
        ...
        if (!intParams.containsKey(name)) {
        	logger.error("Careful, you are getting the value of parameter: " + name + " but the parameter isn't an int parameter...");
            System.exit(1);
        }
