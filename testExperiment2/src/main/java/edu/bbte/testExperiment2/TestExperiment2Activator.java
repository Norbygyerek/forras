package edu.bbte.testExperiment2;
...
public class TestExperiment2Activator implements BundleActivator {

	private static final Logger logger = Logger.getLogger(TestExperiment2Activator.class.getSimpleName());
	...
	public void start(BundleContext context) throws Exception {
		...
		logger.log(Level.INFO,"STARTED the TestExperiment2!");
	...
	public void stop(BundleContext context) throws Exception {
		...
		logger.log(Level.INFO,"STOPPED the TestExperiment2!");
	}
	...
	public void startExperiment() throws InvalidSyntaxException {
		...
		TestExperiment2.setExperiment(roboCommunication);
	}
