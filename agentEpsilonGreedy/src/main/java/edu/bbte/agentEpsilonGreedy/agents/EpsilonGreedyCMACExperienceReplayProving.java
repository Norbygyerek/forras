...
import edu.bbte.agentEpsilonGreedy.agentLib.learningBoosters.experienceReplay.ExperienceReplayLearningBoosterFactory;
 ...
 * @author Brian Tanner
 */
public class EpsilonGreedyCMACExperienceReplayProving extends AbstractSarsa {
    ...
    public static ParameterHolder getDefaultParameters() {
        ...
        p.setDoubleParam("sarsa0-alpha", .125d);
